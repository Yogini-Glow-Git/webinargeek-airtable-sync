...
// lead_magnet-Wert -> Record-Id in der neuen Tabelle "Lead-Magnete"
// (tblMZUOql0RzKxe6g, angelegt 2026-08-12 fuer die Calls/Closings-KPI-Seite
// "Lead-Magnet Performance"). Bestehende 443 Leads wurden per Backfill-Skript
// einmalig verlinkt; ab hier haengt jeder NEUE Lead sich selbst an.
const LEAD_MAGNET_RECORD_ID = {
  yoga_report: "recVr4gqH8cmUiZEH",
  ausbildungsbroschuere: "recX2e9z9APvlEztp",
};
...
export async function processFormSubmitted(contact) {
  ...
  const leadFields = {
    ...
    lead_magnet_ref: LEAD_MAGNET_RECORD_ID[leadMagnet] ? [LEAD_MAGNET_RECORD_ID[leadMagnet]] : [],
